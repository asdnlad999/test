...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="/backend/user" method="post" class="card">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" placeholder="请输入用户邮箱,非必填">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="custom-controls-stacked mt-4">
                                    ...
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="is_admin" value="1">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phone" placeholder="请输入手机号,非必填">
                            </div>
                            <div class="form-group">
